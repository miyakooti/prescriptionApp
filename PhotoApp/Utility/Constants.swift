...
class Constants {
    static let testReservationsData = [
        ReservationSlot(time: "9:00 ~ 9:05", isOpen: true),
        ReservationSlot(time: "9:15 ~ 9:20", isOpen: true),
        ReservationSlot(time: "9:30 ~ 9:35", isOpen: false),
//        ReservationSlot(time: "9:45 ~ 9:50", isOpen: true),
        ReservationSlot(time: "10:00 ~ 10:05", isOpen: true),
...
//        ReservationSlot(time: "10:45 ~ 10:50", isOpen: true),
        ReservationSlot(time: "11:00 ~ 11:05", isOpen: true),
...
//        ReservationSlot(time: "12:00 ~ 12:05", isOpen: true),
...
//        ReservationSlot(time: "12:45 ~ 12:50", isOpen: true),
        ReservationSlot(time: "13:00 ~ 13:05", isOpen: true),
...
//        ReservationSlot(time: "13:30 ~ 13:35", isOpen: true),
        ...
        ReservationSlot(time: "14:00 ~ 14:05", isOpen: true),
        ...
        ReservationSlot(time: "15:00 ~ 15:05", isOpen: true),
...
//        ReservationSlot(time: "15:45 ~ 15:50", isOpen: true),
        ReservationSlot(time: "16:00 ~ 16:05", isOpen: true),
        ...
        ReservationSlot(time: "17:00 ~ 17:05", isOpen: true),
